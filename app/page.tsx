    ...
    <>
      ...
      <section className="py-24 bg-surface-container-lowest/50" id="visionaries">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center mb-16">
          <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg text-on-surface mb-4">The Visionaries</h2>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-3 gap-gutter">
          {/* Founder */}
          <div className="glass glass-glow p-8 rounded-3xl transition-all duration-500 reveal-on-scroll active fade-in-up">
            <div
              className="w-full aspect-[4/5] rounded-2xl mb-6 bg-cover bg-center bg-surface-container-high"
              style={{ backgroundImage: 'url("/founder.jpg")' }}
            ></div>
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-1">Dr. Sahid Cholayil</h3>
            <p className="text-primary font-label-caps text-label-caps uppercase mb-4">Founder & Chairman</p>
            <p className="text-on-surface-variant text-sm">A global leader in healthcare and business, envisioning a thriving entrepreneurial ecosystem for Malappuram&apos;s youth.</p>
          </div>
          {/* Co-Founder 1 */}
          <div className="glass glass-glow p-8 rounded-3xl transition-all duration-500 reveal-on-scroll active fade-in-up">
            <div
            ...
            ></div>
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-1">Shibili Rahman K.P.</h3>
            <p className="text-primary font-label-caps text-label-caps uppercase mb-4">Co-Founder</p>
            <p className="text-on-surface-variant text-sm">Dedicated to operations and scale, ensuring every member of the forum finds the resources they need to succeed.</p>
          </div>
          {/* Co-Founder 2 */}
          <div className="glass glass-glow p-8 rounded-3xl transition-all duration-500 reveal-on-scroll active fade-in-up">
            <div
            ...
            ></div>
            <h3 className="font-headline-sm text-headline-sm text-on-surface mb-1">Muhammed Nabeel P.A.</h3>
            <p className="text-primary font-label-caps text-label-caps uppercase mb-4">Co-Founder</p>
            <p className="text-on-surface-variant text-sm">Leading strategic initiatives and community engagement to foster innovation among the next generation of business minds.</p>
          </div>
        </div>
      </section>
